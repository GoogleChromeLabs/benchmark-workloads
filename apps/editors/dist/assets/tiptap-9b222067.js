import { k as keyName, b as base, t as text } from "./benchmark-connector.min-c6265087.js";
...
const cut = (originRange, targetPos) => ({ editor: editor2, tr }) => {
  const { state } = editor2;
...
const toggleList = (listTypeOrName, itemTypeOrName, keepMarks, attributes = {}) => ({ editor: editor2, tr, state, dispatch, chain, commands: commands2, can }) => {
...
class Node2 {
  ...
  extend(extendedConfig = {}) {
    const extension = new Node2({ ...this.config, ...extendedConfig });
    extension.parent = this;
    this.child = extension;
    extension.name = extendedConfig.name ? extendedConfig.name : extension.parent.name;
    if (extendedConfig.defaultOptions) {
...
//# sourceMappingURL=tiptap-9b222067.js.map
